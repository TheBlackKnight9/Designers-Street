...
export async function GET(req: NextRequest) {
  try {
    ...
    const message = error instanceof Error ? error.message : "Failed to fetch bespoke requests";
...
export async function POST(req: NextRequest) {
  try {
    ...
    const message = error instanceof Error ? error.message : "Failed to submit bespoke request";
