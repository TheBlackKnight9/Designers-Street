  ...
  return (
    <>
      <header
        ...
        className="fixed left-0 right-0 top-0 z-50 bg-canvas/90 backdrop-blur-md border-b border-[var(--border-subtle)]"
      >
        <div className="h-[var(--top-bar-height)] flex items-center justify-between px-3 gap-2">
          ...
          <Link
            ...
            className="flex-1 min-w-0 max-w-[200px] mx-1 flex items-center gap-1.5 px-2.5 py-1.5 rounded-full border-[1.5px] border-espresso/25 bg-chip text-left shadow-[0_1px_3px_rgba(42,31,24,0.1)] active:scale-[0.98] transition-transform"
            aria-label="Manage delivery addresses"
          >
            <svg className="w-3.5 h-3.5 text-charcoal flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="flex items-center gap-0.5 flex-shrink-0" suppressHydrationWarning>
            ...
            >
              <svg className="w-5 h-5 text-charcoal" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
            ...
            <Link href="/profile" className="touch-target p-2" aria-label="Profile">
              <div className="w-7 h-7 rounded-full bg-mist border border-[var(--border-default)] flex items-center justify-center">
                <svg className="w-4 h-4 text-charcoal" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
